...
public class Bullet extends SmoothMover
{
    ...
    /**
     * checkAsteroidHit checks if the asteroid has hit an object, if so, it instructs the scenario to remove the object
     * 
     * @param None There are no parameters
     * @return Nothing is returned
     */
    ...
    {
       //Declare a local Asteroid variable called asteroid that is initialized to a casted reference of one intersecting object of the Asteroid class
       Asteroid asteroid = (Asteroid)getOneIntersectingObject(Asteroid.class);
       
       //If asteroid is not nothing...
       if(asteroid != null)
       {
           // Remove this object from the world
           getWorld().removeObject(this);
           
           //Hit asteroid with DAMAGE
           asteroid.hit(DAMAGE);
       }
    }
}